...
import com.hairops.hair.hairr.Fragment.AdminHome;
import com.hairops.hair.hairr.Home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null){
            ...
            if (!status.equalsIgnoreCase("")||!status.isEmpty()){
                if (status.equalsIgnoreCase("admin")){
                    startActivity(new Intent(Onboarding.this, HomeAdmin.class));
                    finish();
                }else if (status.equalsIgnoreCase("customer")){
                    startActivity(new Intent(Onboarding.this, HomeCustomer.class));
                    finish();
                }else if (status.equalsIgnoreCase("stylist")){
                    startActivity(new Intent(Onboarding.this, HomeStylist.class));
                    finish();
                }
            }else {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Onboarding.this, StackActivity.class));
            }
        });
