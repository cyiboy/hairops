...
public class AdminBooking {
    ...
    private String bookingKey,clientName,clientNumber,stylistName,serviceBooked,numberOfPeople,totalAmount,stylistNumber;
    ...
    public void setStylistNumber(String stylistNumber) {
